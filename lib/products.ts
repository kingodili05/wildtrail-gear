...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'wt-c01',
    slug: 'red-v-raptor-8k-cinema-camera-body',
    name: 'RED V-RAPTOR 8K VV Cinema Camera Body',
    category: 'cameras',
    price: 11000.0,
    description:
      'Flagship 8K VistaVision full-frame cinema body. 17+ stops dynamic range, internal R3D NE + ProRes RAW capture.',
    highlights: [
      '8K VistaVision full-frame sensor, 17+ stops dynamic range',
      'Internal R3D NE + Apple ProRes RAW capture',
      'Up to 120fps at 8K, 240fps at 4K',
      'Compatible with DSMC3 lens mounts',
    ],
    specs: [
      { label: 'Sensor', value: '8K VV 40.96 × 21.60mm' },
      { label: 'Max Frame Rate', value: '8K @ 120fps' },
      { label: 'Recording', value: 'R3D NE, ProRes RAW' },
      { label: 'Lens Mount', value: 'RF / EF / PL via DSMC3' },
    ...
    imageAlt: 'Cinema camera body on rig under tungsten light',
  },
  {
    id: 'wt-c02',
